...
$clave=array_search($user,categorias);
echo $clave;
echo categorias[0];
      ...
      <div class="col s7">
        ...
        <form class="" action="index.html" method="post">
          <div class="input-field col s12">
             <select>
					<?php
							foreach(MODULOSPR as $optidp =>$optpr){ ?>
			                  <option value='<?php echo $optidp;?>'> <?php echo $optpr ?></option>
			          	 <?php	}	 ?>
                 <option value=""></option>
             </select>
      ...
      <div class="col s7">
        ...
        <form class="" action="index.html" method="post">
          <div class="input-field col s12">
			   <select>
          	<?php  	
          		foreach(MODULOSE as $optid =>$optes){ ?>
                  <option value='<?php echo $optid;?>'> <?php echo $optes ?></option>
          	 <?php	}	 ?>
             </select>
             <label class="teal-text">Módulo</label>
           </div>
      ...
      <div class="col s7">
        ...
        <form class="" action="index.html" method="post">
          <div class="input-field col s12">
			...
			foreach(MODULOSPA as $optidpa =>$optpa){ ?>
                  <option value='<?php echo $optidpa;?>'> <?php echo $optpa ; ?></option>
          	 <?php	}	 ?>
      ...
      <div class="card-panel col s10">
        <div class="calendar-container">
          <div class="days">
			...
			while($j<=30) {
			?>	
            <div class="calendar-item hoverable"><span> <?php echo $j;  ?></span></div>
            <?php $j++;  }	 ?>
